...
func customNMAPMatch() {
	...
	nmap.AddMatch("TCP_TerminalServerCookie", `rdp m|^\x03\0\0\x13\x0e\xd0\0\0\x124\0\x02.*\0\x02\0\0\0| p/Microsoft Terminal Services/ o/Windows/ cpe:/o:microsoft:windows/a`)
